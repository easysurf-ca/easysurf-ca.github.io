...
/* Accessible updates for when menu open */
function openNav() {
    document.getElementById("menu-button").setAttribute("aria-expanded", "true");
    document.getElementById("sidenav").setAttribute("class", "sidenav activeMenu");
    document.getElementById("menu-mobile").setAttribute("class", "");
    document.getElementById("close-menu-button").setAttribute("class", "closebtn");
    document.getElementById("close-menu-button").focus();
    
}

/* Accessible updates for when menu closed */
function closeNav() {

    document.getElementById("menu-button").setAttribute("aria-expanded", "false");
    document.getElementById("sidenav").setAttribute("class", "sidenav displayNone");
    document.getElementById("menu-button").focus();
    document.getElementById("menu-mobile").setAttribute("class", "displayNone");
    document.getElementById("close-menu-button").setAttribute("class", "closebtn displayNone");
}
...
/* PLAY/PAUSE BUTTON FOR GRADIENT */


var gradient = document.getElementById('gradient-canvas');

function playPause() {
  
   

if (document.getElementById("play-icon").classList.contains("displayNone")) {
        gradient.pause();
        document.getElementById("pause-button").setAttribute("aria-label", "Play");
        document.getElementById("pause-icon").setAttribute("class", "displayNone");
        document.getElementById("play-icon").setAttribute("class", "");
    }
else {
    gradient.play();
    document.getElementById("pause-button").setAttribute("aria-label", "Pause");
    document.getElementById("pause-icon").setAttribute("class", "");
    document.getElementById("play-icon").setAttribute("class", "displayNone");
}
...
if (document.getElementById("play-icon-mobile").classList.contains("displayNone")) {
        gradient.pause();
        document.getElementById("pause-button-mobile").setAttribute("aria-label", "Play");
        document.getElementById("pause-icon-mobile").setAttribute("class", "displayNone");
        document.getElementById("play-icon-mobile").setAttribute("class", "");
    }
else {
    gradient.play();
    document.getElementById("pause-button-mobile").setAttribute("aria-label", "Pause");
    document.getElementById("pause-icon-mobile").setAttribute("class", "");
    document.getElementById("play-icon-mobile").setAttribute("class", "displayNone");
}
...
const form = document.getElementById("email-us");
...
function validateForm() {
  ...
  if (nameField.value === "") {
    ...
    error1.innerHTML = `${icon} Enter your name.`;
    hasErrors = true;
  }
  if (emailField.value === "") {
    const error = document.createElement("li");
  ...
  if (messageField.value === "") {
    const error = document.createElement("li");
    error.innerHTML = '<a href="#message">A message</a> is required.';
    errors.appendChild(error);
    messageField.setAttribute("aria-invalid", "true");
    error3.innerHTML = `${icon} Enter a message.`;
    hasErrors = true;
  }
  
  if (hasErrors) {
    errorContainer.classList.add("errors");
    if (!errorContainer.querySelector("h3")) {
      const errorHeading = document.createElement("h3");
      errorHeading.innerHTML = "To send your email, please fix these errors:";
