...
if (document.getElementById("play-icon").classList.contains("displayNone")) {
        gradient.pause();
        document.getElementById("pause-button").setAttribute("aria-label", "Play animation");
        document.getElementById("pause-icon").setAttribute("class", "displayNone");
        document.getElementById("play-icon").setAttribute("class", "");
    }
else {
    gradient.play();
    document.getElementById("pause-button").setAttribute("aria-label", "Pause animation");
...
if (document.getElementById("play-icon-mobile").classList.contains("displayNone")) {
        gradient.pause();
        document.getElementById("pause-button-mobile").setAttribute("aria-label", "Play animation");
    ...
    gradient.play();
    document.getElementById("pause-button-mobile").setAttribute("aria-label", "Pause animation");
